...
inputVoucherCode.oninput = () => {
  if (inputVoucherCode.value.length > inputVoucherCode.maxLength)
    inputVoucherCode.value = inputVoucherCode.value.slice(
      0,
      inputVoucherCode.maxLength
    );
};
          ...
          Ajax.post(
            ...
            function (data) {
              ...
              if (!!data && data.errorCode === 0) {
                ...
                document.querySelector("#success-container p").innerHTML =
                  "Log in successfully";

                console.log("verfication code is correct");
              } else {
                document.getElementById("oper-hint").innerHTML =
                  errorHintMap[data.errorCode];
                document
                  .getElementById("hint-container")
                  .classList.remove("hidden");
                document.getElementById("hint-container").classList.add("flex");
                navigator.vibrate(300);

                console.log("verfication code is incorrect");
              }
            }
          );
        }
